...
<Card variant="elevated" className="mb-4">
  <View className="items-center py-6">
    ...
    <View className="flex-row items-center mt-4">
      ...
      <Text className="text-white text-lg font-semibold">Conectado a Supabase</Text>
    </View>
...
<Card variant="outlined" className="mb-4">
  <View className="flex-row items-center mb-3">
    ...
    <Text className="text-white text-lg font-semibold ml-2">Tecnologías</Text>
  </View>
  <View className="space-y-2">
    ...
    <View className="flex-row items-center py-2 border-b border-dark-border">
      ...
      <Text className="text-gray-300 ml-3">Supabase (Backend & DB)</Text>
    </View>
    <View className="flex-row items-center py-2 border-b border-dark-border">
      <Ionicons name="color-palette" size={20} color="#61DAFB" />
      <Text className="text-gray-300 ml-3">NativeWind (Tailwind CSS)</Text>
    </View>
    <View className="flex-row items-center py-2">
      <Ionicons name="flash" size={20} color="#61DAFB" />
      <Text className="text-gray-300 ml-3">Real-time Subscriptions</Text>
    </View>
  </View>
</Card>
...
<Card variant="default">
  <View className="flex-row items-center mb-3">
    ...
    <Text className="text-white text-lg font-semibold ml-2">Acerca de</Text>
  </View>
  <Text className="text-gray-400 text-sm">
    Reactify Dashboard es una aplicación de ejemplo que demuestra 
    la integración de React Native, Expo, Supabase y webhooks de Discord 
